(function () {
  ...
  const DEFAULT_APPEARANCE = {
    fontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    titleFontWeight: 800,
    bodyFontWeight: 400,
    ...
    heroTitleSize: 42,
    bodyTextSize: 14,
    heroTitleFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    heroTitleFontWeight: 800,
    heroLeadFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    heroLeadFontWeight: 400,
    heroLeadFontSize: 13,
    pickerTitleFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    pickerTitleFontWeight: 800,
    pickerTitleFontSize: 20,
    calendarMonthFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    calendarMonthFontWeight: 800,
    calendarMonthFontSize: 16,
    calendarWeekdayFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    calendarWeekdayFontWeight: 400,
    calendarWeekdayFontSize: 13,
    calendarDateFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    ...
    timeButtonHeight: 56,
    timeSlotFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    timeSlotFontWeight: 400,
    timeSlotFontSize: 16,
    timeMetaFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    ...
    formInputHeight: 34,
    formTitleFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    formTitleFontWeight: 700,
    formTitleFontSize: 20,
    formMetaFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    formMetaFontWeight: 400,
    formMetaFontSize: 10,
    formLabelFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    formLabelFontWeight: 400,
    formLabelFontSize: 10,
    formInputFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    formInputFontWeight: 400,
    formInputFontSize: 11,
    formConsentFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    ...
    primaryButtonFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    ...
    successModalTitleFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    successModalTitleFontWeight: 700,
    successModalTitleFontSize: 24,
    successModalTextFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
    successModalTextFontWeight: 400,
    successModalTextFontSize: 15,
    successModalButtonFontFamily: '"Mulish", "Segoe UI", Arial, sans-serif',
